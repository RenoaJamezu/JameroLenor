...
const ContactBox = ({contact}: {contact: ContactItem}) => {
  return (
    <div className="border border-neutral-500 rounded-lg p-4 flex items-center gap-2 min-w-[140px] sm:min-w-40 shadow-sm hover:scale-105 hover:border-neutral-50 transition-transform max-w-full">
